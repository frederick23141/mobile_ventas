...
public class CustomGauge extends View {
    ...
    public CustomGauge(Context context, AttributeSet attrs) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            setStrokeColor(a.getColor(R.styleable.CustomGauge_gaugeStrokeColor, getContext().getColor(android.R.color.darker_gray)));
        }
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            setPointStartColor(a.getColor(R.styleable.CustomGauge_gaugePointStartColor, getContext().getColor( android.R.color.white)));
        }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            setPointEndColor(a.getColor(R.styleable.CustomGauge_gaugePointEndColor, getContext().getColor( android.R.color.white)));
        }

        // divider options
        int dividerSize = a.getInt(R.styleable.CustomGauge_gaugeDividerSize, 0);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            setDividerColor(a.getColor(R.styleable.CustomGauge_gaugeDividerColor, getContext().getColor( android.R.color.white)));
        }
